            ...
            <div className="searchDiv">
                ...
                <ul style={{padding: "1px"}}>
                    {searchResults.map((info) => (
                        <li className="card" title="Add" draggable onDragStart= {(e) => handleFromSearch(e, info)} onClick={(e)=> {handleFromSearch(e, info)}} style={{background: `no-repeat 5% url('../src/assets/anon.PNG'), url('../src/assets/field.JPG')`, fontSize: "12px"}}>
            ...
            <div className="dragHereDiv">
                ...
                <div className="dragHereBox" onDrop={handleFromSearchDrop} onDragOver={handleDragHere}>
                    {searchPlayersArray.map((card) => (
                        <div className="draggedCard" title="Delete" onClick={(e)=> deletePlayer(e, JSON.parse(card).rank_ecr, "fromSearch")} style={{background: `no-repeat 5% url('../src/assets/anon.PNG'), url('../src/assets/field.JPG')`, fontSize: "12px", cursor: "pointer", position: "relative"}}>
            ...
            <div className="dragHereDiv">
                ...
                <div className="dragHereBox" onDrop={handleFromRosterDrop} onDragOver={handleDragHere}>
                    {rosterPlayersArray.map((card) => (
                        <div className="draggedCard" title="Delete" onClick={(e)=> deletePlayer(e, JSON.parse(card).rank_ecr, "fromRoster")} style={{background: `no-repeat 5% url('../src/assets/anon.PNG'), url('../src/assets/field.JPG')`, fontSize: "12px", cursor: "pointer"}}>
                            <p className="playerTeam">{JSON.parse(card).player_team_id}</p>
                            <p className="playerPosition">{JSON.parse(card).player_position_id}</p>
                            <p className="playerName"> {JSON.parse(card).player_name} </p>
                        </div>
                    ...
                    {rosters.map((roster) => (
                        <div className="roster">
                            ...
                            {roster.players.map((player:any) => (
                                <div className="card" title="Add" draggable onDragStart= {(e) => handleFromRoster(e, player)} onClick={(e)=> {handleFromRoster(e, player)}} style={{background: `no-repeat 5% url(../src/assets/anon.PNG), url('../src/assets/field.JPG')`, fontSize: "12px"}}>
